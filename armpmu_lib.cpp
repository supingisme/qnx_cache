...
void setEvtCount()
{
    ...
    write_pmevtypern(1, ARMV8_PMUV3_PERFCTR_L1D_CACHE);
    write_pmevtypern(2, ARMV8_PMUV3_PERFCTR_L1D_CACHE_REFILL);
	write_pmevtypern(3, ARMV8_PMUV3_PERFCTR_L2D_CACHE);
    write_pmevtypern(4, ARMV8_PMUV3_PERFCTR_L2D_CACHE_REFILL);
    write_pmevtypern(5, ARMV8_PMUV3_PERFCTR_UNALIGNED_BR_MIS_PRED);
	for(i=0; i<6; i++){
		write_pmevcntrn(i, 0);
	}
}
